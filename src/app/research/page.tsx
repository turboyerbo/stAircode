...
export default function ResearchPage() {
  return (
    <>
      ...
      <main style={{ maxWidth: 880, margin: '0 auto', padding: '3.5rem 1.25rem 5rem' }}>{/* Hero callout */}
        <div style={{ background: '#0A1C2E', borderRadius: 16, padding: '2.5rem 2rem', marginBottom: '3rem', position: 'relative', overflow: 'hidden' }}><div style={{ position: 'absolute', inset: 0, backgroundImage: 'repeating-linear-gradient(0deg,transparent,transparent 27px,rgba(65,124,164,0.06) 27px,rgba(65,124,164,0.06) 28px),repeating-linear-gradient(90deg,transparent,transparent 27px,rgba(65,124,164,0.06) 27px,rgba(65,124,164,0.06) 28px)' }} />
          <div style={{ position: 'relative' }}><div style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#F29337', marginBottom: '0.75rem' }}>The Cost of Non-Compliance</div>
            <div style={{ fontSize: 'clamp(2.5rem, 7vw, 4.5rem)', fontWeight: 800, letterSpacing: '-0.05em', color: '#F29337', lineHeight: 1 }}>$92B+</div>
            <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '1rem', marginTop: '0.75rem', maxWidth: 560, lineHeight: 1.6 }}>The direct medical costs of non-fatal stair fall injuries in the United States are estimated at over $92 billion annually — making stair safety one of the most costly preventable injury categories in North America.
            </p>
          </div>
        </div>

        {/* Stat grid */}
        <div style={{ marginBottom: '0.75rem' }}><div style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#F29337', marginBottom: '1rem' }}>Key Statistics</div>
        </div>
        ...
        {/* Full problem text */}
        <div style={{ marginBottom: '3rem' }}><h2 style={{ fontSize: '1.5rem', fontWeight: 800, letterSpacing: '-0.03em', marginBottom: '1.25rem', color: '#0D1E2E' }}>The Problem Is Real</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.95rem', lineHeight: 1.8, color: '#2C4A68' }}><p>Unintentional falls result in almost <strong>1,800 emergency department visits</strong> and <strong>417 hospital admissions every day</strong> in Canada alone. Falls are the leading cause of injury-related hospitalizations for Canadians aged 65 and older.</p>
        ...
        <div style={{ background: '#fff', border: '1px solid #E2EAF0', borderRadius: 14, padding: '2rem', marginBottom: '3rem' }}><h3 style={{ fontSize: '1.1rem', fontWeight: 800, marginBottom: '1rem', color: '#0D1E2E' }}>What Causes Non-Compliant Stairs?</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>{[
              ...
              <div key={c.title} style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}><span style={{ fontSize: '1.25rem', flexShrink: 0 }}>{c.icon}</span>
                <div>
        ...
        {/* CTA */}
        <div style={{ textAlign: 'center', marginTop: '4rem', padding: '2.5rem 1.5rem', background: '#0A1C2E', borderRadius: 14 }}><h3 style={{ color: '#fff', fontWeight: 800, fontSize: '1.3rem', marginBottom: '0.75rem', letterSpacing: '-0.02em' }}>Check your stairs in under 5 minutes</h3>
      ...
      <footer style={{ background: '#0A1C2E', color: 'rgba(255,255,255,0.4)', fontSize: '0.78rem', padding: '1.5rem 1.25rem', textAlign: 'center' }}>© {new Date().getFullYear()} Just Open Technologies Inc. — <a href="/marketing" style={{ color: 'rgba(255,255,255,0.4)', textDecoration: 'none' }}>staircode.app</a>
      </footer>
    </>
  )
}
