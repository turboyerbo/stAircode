    ...
    <div style={{ minHeight: '100vh', background: '#fff', fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", color: '#0D1E2E' }}>
      ...
      <div style={{ background: '#0A1C2E', padding: '5rem 1.5rem 4rem' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.6)', lineHeight: 1.8, maxWidth: 580, margin: 0, fontStyle: 'italic' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <section style={{ marginBottom: '4rem' }}>
          <h2 style={{ fontSize: '1.4rem', fontWeight: 900, letterSpacing: '-0.02em', color: '#0D1E2E', marginBottom: '1rem' }}>
        ...
        <section style={{ marginBottom: '4rem', background: '#F7FAFC', borderRadius: 20, padding: '2.5rem' }}>
          ...
          <h2 style={{ fontSize: '1.4rem', fontWeight: 900, letterSpacing: '-0.02em', color: '#0D1E2E', marginBottom: '1rem' }}>
            Two disciplines. One position.
          </h2>
          <p style={{ fontSize: '0.95rem', color: '#3A5A78', lineHeight: 1.9, marginBottom: '1.25rem' }}>
            <a href="https://www.justopenarch.com/" target="_blank" rel="noopener noreferrer" style={{ color: '#0D1E2E', fontWeight: 700, textDecoration: 'underline', textDecorationColor: '#F29337' }}>
        ...
        <div style={{ background: '#0A1C2E', borderRadius: 20, padding: '2.5rem', textAlign: 'center' }}>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 900, color: '#E8F4FF', marginBottom: '0.5rem' }}>
            stAIrcode &mdash; built by architects, for the industry
          </h3>
          <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, marginBottom: '1.5rem' }}>
            Free to scan. $2.99 to unlock the full compliance report.
          </p>
          <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="/?signin=1" style={{ display: 'inline-block', background: 'linear-gradient(135deg,#F29337,#C4721E)', color: '#fff', fontWeight: 800, fontSize: '0.95rem', textDecoration: 'none', padding: '0.85rem 2rem', borderRadius: 12, letterSpacing: '0.04em' }}>
              Check Stairs Now &rarr;
            </a>
            <a href="https://www.justopenarch.com/" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', background: 'transparent', border: '1.5px solid rgba(255,255,255,0.2)', color: 'rgba(255,255,255,0.65)', fontWeight: 600, fontSize: '0.95rem', textDecoration: 'none', padding: '0.85rem 2rem', borderRadius: 12 }}>
              Visit JOA &rarr;
            </a>
          </div>
        </div>
