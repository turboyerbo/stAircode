 ...
 *   $4.99  — Full professional report (one-time, this inspection)
 *   $14.99/mo — Pro (unlimited scans + reports, AR mode)
 *   Enterprise — Contact Sales
 *
 * Plus: Find Architect (free), Retake, Start Over.
 *
 * The $4.99 report is generated by Claude via /api/vision with a text-only
...
export default function ReportScreen({ measurements, fields, codeLabel, codeRef, location, userLatLng, isOntario, userRole, onRetake, onStartOver }: Props) {
  ...
  // ── $14.99/mo Pro: redirect to Stripe subscription checkout ──────────────────
            ...
            {sheet === 'plans' && <>
              ...
              <div style={{ border: `2px solid ${GOLD}`, borderRadius: 16, padding: '1rem 1.1rem', background: 'rgba(242,147,55,0.07)', position: 'relative' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  ...
                  <div style={{ fontSize:'0.62rem', color: profile.text3, fontFamily:'monospace', marginTop:'0.15rem', textDecoration:'line-through' }}>normally $4.99</div>
                </div>
                {[
                ...
                {isTestVariant ? (
                  <div>
                    ...
                    {trialExhausted ? (
                      ...
                      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:'0.4rem', marginTop:'0.45rem' }}>
                        ...
                        <span style={{ fontSize:'0.6rem', color: profile.text3 }}>· Normally $4.99 · Emailed instantly</span>
                      </div>
                    )}
                  </div>
                ) : (
                  <div>
                    ...
                    <div style={{ fontSize:'0.6rem', color: profile.text3, textAlign:'center', marginTop:'0.3rem', fontFamily:'monospace' }}>
                      Free during beta · Normally $4.99
                    </div>
                  </div>
                )}
              ...
              <div style={{ border: `2px solid ${profile.accent}`, borderRadius: 16, padding: '1rem 1.1rem', background: 'rgba(65,124,164,0.08)', position: 'relative' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  ...
                  <div style={{ color: profile.accent, fontWeight: 900, fontSize: '1.2rem' }}>$14.99<span style={{ fontSize: '0.62rem', color: profile.text3, fontWeight: 400 }}>/mo</span></div>
                </div>
                {[
                ...
                <button
                  ...
                  {proLoading ? 'Redirecting…' : 'Start Pro — $14.99/mo →'}
                </button>
              </div>
              ...
              <div style={{ border: `1.5px solid rgba(167,139,250,0.35)`, borderRadius: 16, padding: '0.9rem 1.1rem', background: 'rgba(167,139,250,0.04)', position: 'relative', opacity: 0.85 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  ...
                  <div style={{ color: '#A78BFA', fontWeight: 900, fontSize: '1.2rem' }}>$24.99<span style={{ fontSize: '0.62rem', color: profile.text3, fontWeight: 400 }}>/mo</span></div>
                </div>
                {[
                  'Everything in Pro',
