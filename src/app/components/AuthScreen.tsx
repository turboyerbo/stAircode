  ...
  return (
    <div style={wrap}>
      ...
      <div style={{ textAlign: 'center', margin: '1.6rem 0 1.2rem' }}>
        ...
        <div style={{ fontSize: '0.6rem', letterSpacing: '0.2em', color: 'rgba(28,64,88,0.35)', textTransform: 'uppercase', marginTop: '0.3rem', fontFamily: 'monospace' }}>
      ...
      {/* Store badges */}
      <div style={{ marginTop: '1.6rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.55rem', width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ display: 'flex', gap: '0.6rem', width: '100%' }}>
          <a href="https://play.google.com/store/apps/details?id=app.staircode.android&pcampaignid=web_share" target="_blank" rel="noopener noreferrer"
            style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.3rem', background: 'rgba(44,90,122,0.07)', border: `1.5px solid ${C.border}`, borderRadius: 14, padding: '0.7rem 0.5rem', textDecoration: 'none' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              <svg width="18" height="18" viewBox="0 0 24 24"><path fill="#4285F4" d="M3.18 23.76c.3.17.64.24.99.21l11.87-11.88L12.59 8.6 3.18 23.76z"/><path fill="#EA4335" d="M20.6 10.27l-2.79-1.6-3.43 3.43 3.43 3.43 2.82-1.62c.8-.46.8-1.18-.03-1.64z"/><path fill="#FBBC05" d="M3.18.24C2.83.53 2.6 1.03 2.6 1.7v20.6c0 .67.23 1.17.58 1.46l.09.08 11.54-11.54v-.27L3.27.16l-.09.08z"/><path fill="#34A853" d="M16.04 12.09l-3.43-3.43-9.43 9.43c.38.4.98.44 1.64.08l11.22-6.08z"/></svg>
              <div>
                <div style={{ fontSize: '0.52rem', color: 'rgba(28,64,88,0.5)', lineHeight: 1 }}>GET IT ON</div>
                <div style={{ fontSize: '0.78rem', fontWeight: 700, color: C.navy }}>Google Play</div>
              </div>
            </div>
            <div style={{ fontSize: '0.52rem', fontFamily: 'monospace', color: 'rgba(44,90,122,0.55)', background: 'rgba(44,90,122,0.1)', borderRadius: 6, padding: '0.15rem 0.45rem' }}>AVAILABLE NOW</div>
          </a>
          <a href="https://apps.apple.com/app/staircode/id6744870260" target="_blank" rel="noopener noreferrer"
            style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.3rem', background: 'rgba(44,90,122,0.07)', border: `1.5px solid ${C.border}`, borderRadius: 14, padding: '0.7rem 0.5rem', textDecoration: 'none' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#555"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
              <div>
                <div style={{ fontSize: '0.52rem', color: 'rgba(28,64,88,0.5)', lineHeight: 1 }}>DOWNLOAD ON THE</div>
                <div style={{ fontSize: '0.78rem', fontWeight: 700, color: C.navy }}>App Store</div>
              </div>
            </div>
            <div style={{ fontSize: '0.52rem', fontFamily: 'monospace', color: 'rgba(44,90,122,0.55)', background: 'rgba(44,90,122,0.1)', borderRadius: 6, padding: '0.15rem 0.45rem' }}>LAUNCHING MAY</div>
          </a>
        </div>
      </div>
