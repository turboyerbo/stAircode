...
export default function AuthScreen({ onAuth }: Props) {
  ...
  if (screen === 'otp') return (
    <div style={wrap}>
      ...
      <div style={{ textAlign: 'center', margin: '1.5rem 0 1.2rem' }}><div style={{ fontSize: '1.8rem', fontWeight: 800, letterSpacing: '-0.02em' }}>Check your email</div>
        <div style={{ fontSize: '0.78rem', color: 'rgba(28,64,88,0.55)', marginTop: '0.4rem', lineHeight: 1.5 }}>We sent a 6-digit code to<br />
          <strong style={{ color: C.navy }}>{contact}</strong>
        </div>
      </div>

      <div style={{ width: '100%', maxWidth: 360, background: C.cardBg, border: `1px solid ${C.border}`, borderRadius: 24, padding: '2rem 1.6rem', display: 'flex', flexDirection: 'column', gap: '1.1rem' }}><div style={{ display: 'flex', gap: '0.45rem', justifyContent: 'center' }}>{digits.map((d, i) => (
            <input
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem' }}><button onClick={() => { setScreen('entry'); setError(''); setDigits(['', '', '', '', '', '']) }}
            style={{ background: 'none', border: 'none', color: 'rgba(28,64,88,0.55)', cursor: 'pointer' }}>← Back
          </button>
          {resent
            ? <span style={{ color: '#4ade80' }}> Code sent</span>
            : <button onClick={handleResend} disabled={loading}
                style={{ background: 'none', border: 'none', color: C.navy2, cursor: 'pointer', fontWeight: 600 }}>Resend code
              </button>
          }
        </div>

        <p style={{ margin: 0, fontSize: '0.65rem', color: 'rgba(28,64,88,0.4)', textAlign: 'center', lineHeight: 1.6 }}><strong style={{ color: '#1A3A5C' }}>Check your spam folder</strong> if you don&apos;t see it within 60 seconds.
        </p>
      </div>
    </div>
  )
  ...
  return (
    <div style={wrap}>
      ...
      {/* Main card */}
      <div style={{ width: '100%', maxWidth: 380, background: C.cardBg, border: `1px solid ${C.border}`, borderRadius: 24, padding: '1.75rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>{/* Google */}
        <button
        ...
        {/* Divider */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', margin: '0.25rem 0' }}><div style={{ flex: 1, height: 1, background: C.border }} />
        ...
        {!showEmail ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}><input
      ...
      <div style={{ marginTop: '1.6rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.65rem', width: '100%', maxWidth: 380 }}><div style={{ fontSize: '0.58rem', color: 'rgba(44,90,122,0.35)', letterSpacing: '0.12em' }}>AVAILABLE ON</div>
        <div style={{ display: 'flex', gap: '0.65rem', width: '100%' }}>{/* Google Play */}
          ...
          {/* App Store */}
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.3rem' }}><a href="https://apps.apple.com/app/staircode/id6744870260" target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.55rem', background: '#000', border: '1.5px solid rgba(255,255,255,0.12)', borderRadius: 12, padding: '0.7rem 0.75rem', textDecoration: 'none' }}><svg width="18" height="22" viewBox="0 0 18 22" fill="white" xmlns="http://www.w3.org/2000/svg">
      ...
      <div style={{ display: 'flex', gap: '0.65rem', marginTop: '1rem', justifyContent: 'center' }}>{/* Instagram — gradient background with camera SVG */}
        <a href="https://www.instagram.com/staircode/" target="_blank" rel="noopener noreferrer"
          style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', background: 'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)', borderRadius: 12, textDecoration: 'none', color: '#fff', fontSize: '0.75rem', fontWeight: 700 }}>{/* Official Instagram camera icon */}
        ...
        <a href="https://www.facebook.com/people/Staircode/61589350702805/" target="_blank" rel="noopener noreferrer"
          style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', background: '#1877F2', borderRadius: 12, textDecoration: 'none', color: '#fff', fontSize: '0.75rem', fontWeight: 700 }}>{/* Official Facebook f logo */}
      ...
      <p style={{ fontSize: '0.6rem', color: C.navy2, textAlign: 'center', marginTop: '0.75rem', lineHeight: 1.7, maxWidth: 300 }}>By continuing you agree to our{' '}
