...
export default function ScanModeSelect({ onSelect }: Props) {
  return (
    <div style={{
      ...
      {/* Heading */}
      <h1 style={{ fontSize: '1.55rem', fontWeight: 900, color: TEXT, textAlign: 'center', margin: '0 0 0.4rem', letterSpacing: '-0.02em' }}>
        Who is this scan for?
      </h1>
      <p style={{ fontSize: '0.78rem', color: TEXT2, textAlign: 'center', margin: '0 0 2rem', lineHeight: 1.55, maxWidth: 320 }}>
        Choose based on your situation. Both modes produce a full compliance report.
      </p>

      {/* Cards */}
      <div style={{ width: '100%', maxWidth: 420, display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
          ...
          <div style={{ display:'flex', alignItems:'flex-start', gap:'1rem' }}>
            ...
            <div style={{ flex:1 }}>
              <div style={{ display:'flex', alignItems:'center', gap:'0.5rem', marginBottom:'0.5rem' }}>
                <span style={{ fontSize:'1.1rem', fontWeight:900, color:TEXT }}>Individual</span>
        ...
        >
          ...
          <div style={{ display:'flex', alignItems:'flex-start', gap:'1rem' }}>
            ...
            <div style={{ flex:1 }}>
              <div style={{ display:'flex', alignItems:'center', gap:'0.5rem', marginBottom:'0.5rem' }}>
                <span style={{ fontSize:'1.1rem', fontWeight:900, color:TEXT }}>Professional</span>
              ...
              <p style={{ fontSize:'0.78rem', color:TEXT2, margin:0, lineHeight:1.65 }}>
                For architects, contractors, building managers, and real estate. AI coaches each frame for best accuracy.
              </p>
            </div>
          </div>
      ...
      {/* Footer note */}
      <p style={{ fontSize:'0.62rem', color:TEXT3, textAlign:'center', marginTop:'1.5rem', lineHeight:1.6, maxWidth:320 }}>
        Both modes produce the same full compliance report.
      </p>
    </div>
  )
}
