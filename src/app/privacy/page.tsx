...
export default function PrivacyPage() {
  ...
  return (
    <div style={{ position:'fixed', inset:0, overflowY:'auto', background:'#ffffff', zIndex:9999 }}><main style={{ maxWidth: 720, margin: '0 auto', padding: '3rem 1.5rem 5rem', fontFamily: "system-ui, sans-serif", color: '#111827', lineHeight: 1.75 , background: '#ffffff'}}><a href="javascript:history.back()" style={{ display:'inline-flex', alignItems:'center', gap:'0.4rem', color:'#1d4ed8', fontSize:'0.82rem', marginBottom:'2rem', textDecoration:'none', fontFamily:'system-ui,sans-serif' }}>← Back</a>
      ...
      <p style={{ marginTop: '3rem', fontSize: '0.8rem', color: '#4b5563' }}>© {new Date().getFullYear()} Just Open Technologies Inc. All rights reserved.
      </p>
    </main>
    </div>
  )
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section style={{ marginBottom: '2rem' }}><h2 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '0.6rem', color: '#0A1C2E' }}>{title}</h2>
