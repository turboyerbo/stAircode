  ...
  return(
    <div style={{flex:1,display:'flex',flexDirection:'column'}}>
      ...
      <div style={{flex:1,padding:'1.25rem',display:'flex',flexDirection:'column',gap:'0.8rem',background:'#EBF3FA'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'0.55rem',marginTop:'0.9rem',width:'100%',maxWidth:340,alignSelf:'center'}}>

          {/* Row 1: Instagram + Facebook */}
          <div style={{display:'flex',gap:'0.5rem'}}>
            <a href="https://www.instagram.com/staircode/" target="_blank" rel="noopener noreferrer"
              style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',gap:'0.45rem',padding:'0.55rem 0.75rem',background:'linear-gradient(135deg,#833ab4,#fd1d1d,#fcb045)',border:'none',borderRadius:12,textDecoration:'none',color:'#fff',fontSize:'0.72rem',fontWeight:700}}>
            ...
            <a href="https://www.facebook.com/people/Staircode/61589350702805/" target="_blank" rel="noopener noreferrer"
              style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',gap:'0.45rem',padding:'0.55rem 0.75rem',background:'#1877F2',border:'none',borderRadius:12,textDecoration:'none',color:'#fff',fontSize:'0.72rem',fontWeight:700}}>
          ...
          <a href="https://play.google.com/store/apps/details?id=app.staircode.android&pcampaignid=web_share" target="_blank" rel="noopener noreferrer"
            style={{display:'flex',alignItems:'center',gap:'0.65rem',padding:'0.6rem 1rem',background:'#000',border:'1px solid rgba(255,255,255,0.12)',borderRadius:12,textDecoration:'none'}}>
          ...
          {/* About link */}
          <a href="/marketing"
            style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'0.4rem',padding:'0.45rem 0.9rem',background:'rgba(65,124,164,0.08)',border:'1px solid rgba(65,124,164,0.2)',borderRadius:20,textDecoration:'none',color:'#2C5A7A',fontSize:'0.65rem',fontWeight:600,alignSelf:'center'}}>
            🌐 About stAIrcode
          </a>
        </div>
