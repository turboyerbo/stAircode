...
export default function WhatIsStaircodeePage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0A1C2E', color: '#fff', fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif" }}>

      {/* Nav */}
      <header style={{ padding: '1.25rem 1.5rem', borderBottom: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '3rem 1.5rem' }}>
        ...
        <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: '1.25rem', color: '#E8F4FF' }}>
          What is st<span style={{ color: '#F29337' }}>AI</span>rcode?
        </h1>

        <p style={{ fontSize: '1.05rem', color: 'rgba(255,255,255,0.78)', lineHeight: 1.8, marginBottom: '2.5rem', maxWidth: 620 }}>
          stAIrcode is an AI-powered stair compliance tool that lets anyone — from homeowners to building managers — check whether a staircase meets local building code requirements using nothing but a smartphone. No tape measure. No technical knowledge. No site visit required from an engineer.
        </p>

        {/* YouTube video */}
        <div style={{ borderRadius: 18, overflow: 'hidden', border: '1px solid rgba(65,124,164,0.25)', boxShadow: '0 8px 40px rgba(0,0,0,0.5)', marginBottom: '3rem', maxWidth: 420, margin: '0 auto 3rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', marginBottom: '3rem' }}>
          {[
            ...
            <div key={item.title} style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(65,124,164,0.15)', borderRadius: 14, padding: '1.25rem' }}>
