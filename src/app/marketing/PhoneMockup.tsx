...
const PHONE_SCREENS = [
  {
    ...
    alt:         'Review stair measurements before generating report',
  ...
  },
  {
    ...
    alt:         'Foundation weeping tile AI analysis — filter fabric missing, action required',
    label:       'AI Analysis',
    badge:       'REPORT',
    badgeColor:  '#C4780A',
  },
  {
    ...
    alt:         'Generate Report dashboard — assemble and send final PDF report',
