...
const ARCHITECT: ProfileTheme = {
  ...
  copy: {
    ...
    proTitle: 'Full Inspection Access', proPrice: '$38.99/month', proNote: 'Unlimited scans and reports, all codes. Cancel anytime.',
...
const BUILDING_MANAGER: ProfileTheme = {
  ...
  copy: {
    ...
    reportPrice: 'Generate Report — Subscription Required', reportPriceNote: 'Subscribe for $38.99/month · Cancel anytime',
    proTitle: 'Full Inspection Access', proPrice: '$38.99/month', proNote: 'Unlimited assessments. Ideal for multi-unit buildings.',
...
const CONTRACTOR: ProfileTheme = {
  ...
  copy: {
    ...
    reportPrice: 'Generate Report — Subscription Required', reportPriceNote: 'Subscribe for $38.99/month · Cancel anytime',
    proTitle: 'Full Inspection Access', proPrice: '$38.99/month', proNote: 'Unlimited checks across all your sites.',
...
const DIY: ProfileTheme = {
  ...
  copy: {
    ...
    reportPrice: 'Generate Report — Subscription Required', reportPriceNote: 'Subscribe for $38.99/month · Cancel anytime',
    proTitle: 'Full Inspection Access', proPrice: '$38.99/month', proNote: 'Unlimited scans and reports. Cancel anytime.',
...
const REALESTATE: ProfileTheme = {
  ...
  copy: {
    ...
    reportPrice: 'Generate Report — Subscription Required', reportPriceNote: 'Subscribe for $38.99/month · Cancel anytime',
    proTitle: 'Full Inspection Access', proPrice: '$38.99/month', proNote: 'Assess every property in your portfolio.',
